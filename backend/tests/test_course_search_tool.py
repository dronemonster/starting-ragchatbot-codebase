...
class TestCourseSearchToolExecute:
    def test_returns_formatted_results_with_headers(self, mock_vector_store, sample_search_results):
    ...
    def test_passes_query_and_filters_to_vector_store(self, mock_vector_store, sample_search_results):
        mock_vector_store.search.return_value = sample_search_results
        tool = CourseSearchTool(mock_vector_store)
    ...
    def test_empty_results_includes_course_and_lesson_filter_info(self, mock_vector_store, empty_search_results):
        mock_vector_store.search.return_value = empty_search_results
        tool = CourseSearchTool(mock_vector_store)
    ...
    def test_store_error_is_returned_verbatim_not_raised(self, mock_vector_store, error_search_results):
    ...
    def test_sources_are_tracked_with_lesson_links(self, mock_vector_store, sample_search_results):
        mock_vector_store.search.return_value = sample_search_results
    ...
    def test_source_link_falls_back_to_course_link_when_no_lesson_link(self, mock_vector_store):
    ...
    def test_source_has_no_lesson_suffix_when_lesson_number_missing(self, mock_vector_store):
        results = make_search_results(
    ...
    def test_last_sources_reset_between_calls(self, mock_vector_store, sample_search_results, empty_search_results):
        tool = CourseSearchTool(mock_vector_store)
